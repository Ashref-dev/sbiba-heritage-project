    ...
    <div className="container relative mx-auto flex flex-col gap-4 overflow-hidden py-4 lg:flex-row lg:py-6">
      ...
      <div className="bite-br flex flex-1 animate-fade-in-left items-center justify-center overflow-hidden rounded-2xl bg-[#f28809] px-4 py-8 sm:rounded-3xl md:px-8 lg:px-16 lg:py-12">
        ...
        <div className="flex max-w-3xl flex-col items-center text-center">
          <div className="animate-fade-in-up-delay-7 mb-4 inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1.5 shadow-sm backdrop-blur-sm transition-transform hover:scale-105 sm:mb-6 sm:px-4 sm:py-2">
          ...
          <h1 className="text-shadow animate-fade-in-up-delay-8 mb-4 font-sans text-4xl font-medium tracking-tight text-white sm:mb-6 sm:text-5xl md:text-6xl lg:mb-8 lg:text-7xl">
            Your{" "}
          ...
          <p className="animate-fade-in-up-delay-8 mb-6 max-w-xl text-lg leading-relaxed text-white sm:mb-8 sm:text-xl lg:mb-10 lg:text-2xl">
            Discover the enchanting blend of Roman heritage and Berber culture
            in the heart of Kasserine
          </p>

          <div className="animate-fade-in-up-delay-9 space-y-4 sm:space-y-6">
            <VideoModal />

            <div className="animate-fade-in-up-delay-9 flex items-center gap-3 sm:gap-4">
      ...
      <div className="bite-bl relative min-h-[30em] flex-1 animate-fade-in-right overflow-hidden rounded-2xl sm:rounded-3xl">
        ...
        {/* Floating Elements - Fade in after right side */}
        <div className="relative h-[26em] p-4 sm:p-6 lg:h-full lg:p-8">
          ...
          {/* Bottom Info - Fades in after right side elements */}
          <div className="animate-fade-in-up-delay-5 absolute inset-x-2 bottom-2 flex items-center justify-between sm:bottom-2 sm:left-[68px] sm:right-8">
