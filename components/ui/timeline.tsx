    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-lg text-black dark:text-white md:text-4xl">
          Chronicles of Sbiba: A Journey Through Time
        </h2>
        <p className="max-w-sm text-sm text-neutral-700 dark:text-neutral-300 md:text-base">
          Nestled in Tunisia&apos;s Kasserine Governorate, Sbiba&apos;s rich
          history spans from ancient Roman settlements to modern agricultural
          development.
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-[#f28809] via-[#f23f00] to-transparent"
          />
        </div>
      </div>
    </div>
